...
**録音を、確認・絞り込み・出力ができる音声素材ライブラリへ。**

[简体中文](../../README.md) · [English](../en/README.md) · **日本語**

AudioRegistry は、話者分離、文字起こし、タイムラインでの確認、複数プロジェクトのデータ構成をローカルで行うワークスペースです。元の音声は移動せず、プロジェクト情報、時間座標、注釈をローカルの SQLite データベースに保存します。
